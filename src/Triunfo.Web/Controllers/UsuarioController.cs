...
namespace Triunfo.Web.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public UsuarioController(TriunfoDbContext context)
        {
            _context = context;
        }
        ...
        {
            var triunfoDbContext = _context.Usuario.Include(u => u.IdPersonaNavigation);
        ...
        {
            ViewData["IdPersona"] = new SelectList(_context.Persona, "IdPersona", "ApellidoPersona");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,IdPersona,RolUsuario,ClaveUsuario,EstadoUsuario")] Usuario usuario)
        {
